...
spline = BF_spap2(numPolyPieces,splineOrder,1:N,y); % just a single middle knot with cubic interpolants
y_spl = BF_fnval(spline,1:N); % evaluated at the 1:N time intervals
y = y - y_spl';
if doPlot
    figure('color','w');
    box('on');
