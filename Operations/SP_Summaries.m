...
s = BF_fitoptions('Method','NonlinearLeastSquares','StartPoint',[csS(end), 100]);
f = BF_fittype('a*x^2/(b+x^2)','independent','x','options',s); % set 'a' from maximum
[c, gof] = BF_fit(w',csS',f);
out.fpolysat_a = c.a;
